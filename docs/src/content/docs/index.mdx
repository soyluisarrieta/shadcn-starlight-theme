...
description: Showcase Shadcn-based components with the power of Starlight.
head:
  - tag: title
    content: shadcn-starlight-theme
  - tag: style
    content: |
      .hero-html {
        --size: 12rem;
...
editUrl: false
hero:
  tagline: Showcase Shadcn-based components with the power of Starlight.
  image:
    html: '🔳'
  actions:
    - text: Get Started
